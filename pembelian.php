...
<body>
	...
	<div class="content container-fluid">
		...
		<a href="pembelian_tambah.php" class="btn btn-primary" >Tambah</a>
		<br/>
		<br/>
		<div style="width : 1000px:">
			<table class="table table-bordered table-striped table-hover table-sort">
				...
				<?php
					$query = "select * from pembelian inner join supplier on pembelian.id_supplier=supplier.id_supplier"; //ambil smua data table satuan
				...
				?>
					<tr>
						...
						<td>
							<a href="pembelian_detail.php?id_pembelian=<?php echo $row["id_pembelian"]; ?>" class="btn btn-info">Detail</a> 
						</td>
					</tr>
				<?php
					}
