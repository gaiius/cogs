<?php
	...
	if(isset($_POST["simpan"]))
	{
		...
		{
			?><script>alert("Id satuan sudah ada sebelumnya");</script><?php
			$error = 1;
		}
		...
		if($error == 0)
		{
			$query = "insert into satuan(id_satuan,nama_satuan) values ('$id_satuan','$nama_satuan')";
			mysql_query($query);
			...
			<table class="table table-bordered table-striped table-hover ">
				<thead>	<!-- kop table -->
					...
					<tr>
						...
						<td><input required style="width:150px"; class="form-control" name="id_satuan" id="id_satuan" placeholder="Id Satuan" value="<?php echo $id_satuan; ?>" /></td>
					</tr>
					<tr>
						<td>Nama Satuan</td>
