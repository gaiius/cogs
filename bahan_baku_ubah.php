	...
	if(isset($_POST["simpan"]))
	{
		...
		if($error == 0)
		{
			$query = "update bahan_baku set
						nama_bahan_baku='$nama_bahan_baku',stok='$stok',
						satuan_stok='$satuan_stok',satuan_beli='$satuan_beli',
						konversi='$konversi',harga_beli='$harga_beli',harga_average='$harga_average'
			...
			<table class="table table-bordered table-striped table-hover ">
				<thead>	<!-- kop table -->
					...
					<tr>
						...
						<td><input readonly required style="width:150px"; class="form-control" name="id_bahan_baku" id="id_bahan_baku" placeholder="Id Bahan Baku" value="<?php echo $id_bahan_baku; ?>" /></td>
					</tr>
					<tr>
